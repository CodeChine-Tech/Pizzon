          ...
          {specials.map((s, i) => (
            <div key={i} className="pizza-card rounded-xl overflow-hidden shadow-lg border border-gray-100">
              <div className="relative overflow-hidden" style={{ height: 'clamp(180px,25vw,224px)' }}>
                ...
                <span className="absolute top-4 left-4 text-white text-xs font-bold px-3 py-1.5 rounded" style={{ background: '#e8342e' }}>{s.tag}</span>
              </div>
              <div className="p-5">
                ...
                <div className="flex items-center justify-between flex-wrap gap-2">
                  ...
                  <button className="btn-red text-xs py-2 px-5">Order Now</button>
                </div>
              </div>
            </div>
          ))}
